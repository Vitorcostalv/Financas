...
exports.parseBRLToCents = parseBRLToCents;
exports.formatCentsToBRL = formatCentsToBRL;
exports.splitInstallmentsExact = splitInstallmentsExact;
...
function splitInstallmentsExact(totalCents, count) {
    if (count <= 0) {
        return [];
    }
